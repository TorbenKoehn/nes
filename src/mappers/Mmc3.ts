...
const MMC3_MIRRORS = [MirrorType.VERTICAL, MirrorType.HORIZONTAL];
...
export default class Mmc3 extends Mapper
{
     ...
     */
    control(address: number, value: number): void
    {
        let isEven = address % 2 === 0;
